...
def main():
    ...
    parser.add_argument("--output_dir_mono_model", default="saved_model/unixcoder_RR_test/CSN/ruby/", type=str, # /home/donghande/unimodel/saved_model/CSN/ruby/UniModel
                        help="The saved model checkpoint.")
    ...
    parser.add_argument("--atK", default=10, type=int,
    ...
    parser.add_argument("--temperature", default=20, type=int,
                        help="Total number of training epochs to perform: \
                            20 for CSN and cosqa datasets; 40 for StaQC and AdvTest datasets")
    ...
    parser.add_argument('--lam', default=0, type=float, 
                        help="0.0 for CSN, cosqa, AdvTest datasets; 0.004 for StaQC dataset")
